...
with open("final_predicted_rt_userp.txt") as f1:
    text1 = f1.read()
...
for val in values:
	...
	news = news[:-1]
	final.append(news)
with open("rtmodifiedweb.txt") as f2:
    text2 = f2.read()
values2 = re.split(r'[\n\r]+', text2)
...
for val in values:
	...
	news = news[:-1]
	N1.append(news)
with open("krtservices.csv") as f4:
    text4 = f4.read()
...
for val in values:
	...
	news = news[:-1]
	N2.append(news)
with open("rtsimusers.txt") as f5:
    text5 = f5.read()
...
for c in range(len(final)):
	...
	for s in final[c]: 
		print i,c
		print final[c][i]
		with open("predicted_rt_userp.txt","a") as f5:
			f5.write("%f " % (userp[c][i]))
		with open("predicted_rt_itemp.txt","a") as f6:
		...
		with open("predicted_rt_all_u.txt","a") as f4:
			f4.write("%f " % (predicted1[c][i]))
		with open("predicted_rt_all_i.txt","a") as f7:
