...
for c in range(len(final)):
	...
	for s in final[c]: 
		print i,c
		print final[c][i]
		with open("final_predicted_usd_userp.txt","a") as f5:
			f5.write("%f " % (userp[c][i]))
		with open("final_predicted_usd_itemp.txt","a") as f6:
		...
		with open("final_predicted_usd_all_u.txt","a") as f4:
			f4.write("%f " % (predicted1[c][i]))
		with open("final_predicted_usd_all_i.txt","a") as f7:
